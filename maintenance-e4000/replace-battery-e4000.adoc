...
+
... Wählen Sie *Hardware*.
... Wenn die Grafik die Laufwerke anzeigt, wählen Sie *Controller & Components*, um die Controller anzuzeigen
...
+
.. Wählen Sie *Storage › Volumes*. Überprüfen Sie auf der Seite *All Volumes*, ob die Volumes den bevorzugten Besitzern zugeordnet sind. Wählen Sie *More › Change ownership*, um die Besitzer der Volumes anzuzeigen.
