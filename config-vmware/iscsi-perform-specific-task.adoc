...
Als Best Practice sollten Sie BEI E-Series Storage-Arrays nicht die Portbindung verwenden. Siehe https://www.netapp.com/media/17017-tr4789.pdf["TR-4789:VMware Konfigurationshandbuch für die E-Series SANtricity iSCSI-Integration mit ESXi 6.x und 7.x"] Finden Sie weitere Informationen.
