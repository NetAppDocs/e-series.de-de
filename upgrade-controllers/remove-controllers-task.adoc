...
[role="tabbed-block"]
====
.EF80 und EF50 Controller-Modelle
--
Informationen zum Entfernen von Controllern aus EF80- und EF50-Speichersystemen finden Sie unter link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-1-remove-the-controller["EF50 und EF80 - Schritt 1: Entfernen Sie den Controller"^].
