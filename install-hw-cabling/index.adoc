...
---
= Verkabelung Ihres Speichersystems - E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Falls Ihr Controller-Regal (Speichersystem) unten nicht aufgeführt ist, siehe link:../getting-started/getup-run-concept.html["Schnellstart für E-Series"^] und klicken Sie auf den Link für Ihr spezifisches Speichersystem, um auf die Verkabelungsinformationen zuzugreifen.
...
Wenn Sie die Verkabelung für eine der folgenden Konfigurationen vornehmen, siehe https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057["Hinzufügen von IOM-Laufwerk-Shelfs zu einem vorhandenen E27XX-, E56XX- oder EF560-Controller-Shelf"^]
