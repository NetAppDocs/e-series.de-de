...
NOTE: Die folgenden Informationen gelten nicht für alle Speichersysteme. Informationen zur Hostverkabelung speziell für Ihr Speichersystem finden Sie link:../getting-started/getup-run-concept.html["Schnellstart für E-Series"^] und klicken Sie auf den Link für Ihr spezifisches Speichersystem.
