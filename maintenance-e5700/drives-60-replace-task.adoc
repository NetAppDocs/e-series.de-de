...
---
= Austauschen des Laufwerks – E5700 (Shelf mit 60 Laufwerken)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
Diese Aufgabe gilt für DCM-, DCM2- und DCM3-Laufwerksregale.
...
+
image::../media/2860_dwg_attn_led_on_drawer_maint-e5700.gif[Warnungs-LED]
...
+
image::../media/28_dwg_e2860_de460c_attention_led_drive_maint-e5700.gif[Achtung-LED an der Laufwerksschublade]
...
+
image::../media/trafford_drive_rel_button_maint-e5700.gif[Orangefarbener Entriegelungsriegel zum Entfernen des Laufwerks]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[Den Antrieb mit dem Nockengriff entfernen]
