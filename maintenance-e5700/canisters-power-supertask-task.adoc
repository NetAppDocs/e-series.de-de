...
---
= Austauschen des Strombehälters - E5700 (60 Laufwerke)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
.. Wählen Sie *Hardware*.
.. Sehen Sie sich das Power-image:../media/sam1130_ss_hardware_power_icon_maint-e5700.gif["Ein/aus-Symbol"]Symbol rechts neben der Dropdown-Liste *Shelf* an, um festzustellen, welches Shelf den defekten Strombehälter hat.
+
...
+
image::../media/28_dwg_e2860_de460c_psu_w_callouts_maint-e5700.gif[LEDs des Netzbehälters]
