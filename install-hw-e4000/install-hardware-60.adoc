...
CAUTION: Ein leeres Regal wiegt ungefähr 134 lb (61 kg). Für den sicheren Transport eines leeren Regals ist ein mechanisierter Aufzug oder vier Personen erforderlich, die die Hebegriffe benutzen.
