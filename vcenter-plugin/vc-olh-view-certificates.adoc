...
. Um weitere Informationen zu einem Zertifikat anzuzeigen, wählen Sie die entsprechende Zeile aus, wählen Sie die Auslassungspunkte am Ende der Zeile aus und klicken Sie dann auf *Anzeigen* oder *Exportieren*.
