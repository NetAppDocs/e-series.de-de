...
Um die E-Series Hardware zu installieren, rufen Sie die Installations- und Einrichtungsanweisungen für Ihr Storage Array und Ihren Shelf-Typ auf (falls zutreffend):

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["EF50- oder EF80-Speichersystem"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["SANtricity System Manager Online-Hilfe für 12.0x"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["SANtricity System Manager Online-Hilfe für 11.9x"^]
