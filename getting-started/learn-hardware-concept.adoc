...
Einige der verfügbaren E-Series-Array-Modelle sind unten aufgeführt. Eine vollständige Liste der E-Series-Array-Modelle und ihrer Hardware-Spezifikationen finden Sie im NetApp Hardware Universe unter https://hwu.netapp.com["NetApp Hardware Universe"^].

* EF50-Serie – Einstiegsmodell, komplett Flash, komplett NVMe
* EF80-Serie – Mittelklasse All Flash, All NVMe
...
NOTE: Für SANtricity OS 11.80GA oder höher sind alle USB-Ports deaktiviert, während SANtricity OS ausgeführt wird.
...
+
--
* Unterstützt NVMe-SSD-Laufwerke mit folgenden Kapazitäten:
+
** 3,8 TB
** 7,6 TB
** 15,3 TB
...
* Unterstützen Sie bis zu 24 NVMe-SSD-Laufwerke im Controller-Einschub.
* Unterstützung für eine oder zwei Host-Schnittstellenkarten pro Controller.
* Unterstützung für Inter-Controller-Karten und Kabel für die Kommunikation zwischen zwei Controllern.
+

NOTE: Beim Konfigurieren Ihres EF50-Systems ist es entscheidend, die Spiegelungskabel korrekt anzuschließen. Weitere Informationen finden Sie unter https://docs.netapp.com/us-en/e-series/install-hw-ef50-ef80/install-cable.html#step-1-cable-the-inter-controller-mirroring-connections["Verkabeln Sie die Spiegelungsverbindungen zwischen den Controllern – EF50 und EF80"].
...
* Unterstützen Sie bis zu 24 NVMe-SSD-Laufwerke im Controller-Einschub.
* Unterstützung für eine, zwei oder drei Host-Schnittstellenkarten pro Controller.
* Unterstützung für Inter-Controller-Karten und Kabel für die Kommunikation zwischen zwei Controllern.
+

NOTE: Beim Konfigurieren Ihres EF80-Systems ist es entscheidend, die Spiegelungskabel korrekt anzuschließen. Weitere Informationen finden Sie unter https://docs.netapp.com/us-en/e-series/install-hw-ef50-ef80/install-cable.html#step-1-cable-the-inter-controller-mirroring-connections["Verkabeln Sie die Spiegelungsverbindungen zwischen den Controllern – EF50 und EF80"].
