...
---
= Ersetzen Sie die fehlerhafte Host Interface Card (HIC) in EF300 oder EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Gehen Sie folgendermaßen vor, um eine fehlerhafte Host Interface Card (HIC) in einem EF300- oder EF600-Array zu ersetzen.
