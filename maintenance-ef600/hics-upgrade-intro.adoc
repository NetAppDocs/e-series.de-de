...
. Wählen Sie im SANtricity System Manager im Menü „Storage“ die Option „Operations in Progress“. Warten Sie, bis alle Vorgänge abgeschlossen sind, bevor Sie mit dem nächsten Schritt fortfahren.
