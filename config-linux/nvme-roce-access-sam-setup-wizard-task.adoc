...
---
= Storage-Konfiguration mit SANtricity System Manager – Linux (NVMe over RoCE)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie den Speicher im SANtricity System Manager konfiguriert haben, link:nvme-roce-configure-switch-task.html["Konfigurieren Sie die Switches"].
