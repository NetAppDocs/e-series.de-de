...
---
= Konfiguration von IP-Adressen mit DHCP in E-Series – Linux (iSER over InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Ein DHCP-Server, der auf demselben Subnetz installiert und konfiguriert ist wie die Speicherverwaltungsports.
