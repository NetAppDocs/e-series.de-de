...
.Über diese Aufgabe
Diese Aufgabe beschreibt, wie Sie über die Hardware-Seite des System Manager auf die iSCSI-Portkonfiguration zugreifen. Sie können auch über menu:System[Einstellungen > System > iSCSI-Ports konfigurieren] auf die Konfiguration zugreifen.
