...
+
*Red Hat Enterprise Linux 8, 9 und 10 (RHEL 8, RHEL 9 und RHEL 10)*
...
----
+
*SUSE Linux Enterprise Server 12, 15 und 16 (SLES 12, SLES 15 und SLES 16)*
...
iscsiadm -m session
----
.. Überprüfen Sie den iSCSI-Sitzungsstatus des Arrays. Navigieren Sie im SANtricity System Manager zu *Einstellungen* > *System* > *iSCSI-Sitzungen anzeigen/beenden*.
