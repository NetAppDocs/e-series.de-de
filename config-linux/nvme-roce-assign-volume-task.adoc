...
---
= Zuweisung eines Volumes mit SANtricity System Manager – Linux (NVMe over RoCE)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Schritte
. Wählen Sie im linken Bereich der SANtricity System Manager-Oberfläche Menü:Storage[Hosts].
...
Nachdem Sie ein Volumen zugewiesen haben, link:nvme-roce-display-volumes-visible-host-task.html["Die sichtbaren Volumes für den Host anzeigen"].
