...
Nachdem Sie die Unterstützung für die Linux-Konfiguration überprüft und die Einschränkungen geprüft haben, link:nvme-roce-configure-ip-address-dhcp-task.html["IP-Adressen mithilfe von DHCP konfigurieren"].
