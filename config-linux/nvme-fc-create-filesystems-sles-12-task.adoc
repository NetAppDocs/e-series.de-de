...
---
= Erstellen von Filesystemen in der E-Series – SLES 12 (NVMe over FC)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Für SLES 12 erstellen Sie ein Dateisystem auf dem gewünschten dm-Gerät und mounten das Dateisystem.
