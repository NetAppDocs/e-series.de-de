...
.Bevor Sie beginnen
Sie müssen das neueste kompatible Betriebssystem RHEL 8, RHEL 9, RHEL 10, SLES 12, SLES 15 oder SLES 16 mit Service Pack verwenden. Siehe die https://mysupport.netapp.com/matrix["NetApp Interoperabilitäts-Matrix-Tool"^] Eine vollständige Liste der aktuellen Anforderungen finden Sie hier.
