...
---
= Globale eindeutige Host-Port-IDs in der E-Series festlegen – Linux (iSER over InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Notieren Sie die GUIDs des Initiators auf der xref:iser-ib-worksheet-concept.adoc[Arbeitsblatt für iSER-over-InfiniBand].
