...
summary: Für SLES 12 erstellen Sie ein Dateisystem im Namespace und mounten das Dateisystem. 
---
= Erstellen von Filesystemen in der E-Series – Linux SLES 12 (NVMe over InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Für SLES 12 erstellen Sie ein Dateisystem im Namespace und mounten das Dateisystem.
