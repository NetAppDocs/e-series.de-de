...
summary: Konfigurieren Sie Multipath-Software so, dass sie einen redundanten Pfad zum Storage Array bereitstellen kann, falls einer der physischen Pfade unterbrochen wird. 
---
= Multipath-Software in E-Series konfigurieren – Linux (SRP over InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
