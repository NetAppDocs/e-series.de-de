...
---
= IP-Adressen mit DHCP in E-Series – Linux (NVMe over RoCE) konfigurieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie die IP-Adressen mithilfe von DHCP konfiguriert haben, link:nvme-roce-access-sam-setup-wizard-task.html["Konfigurieren Sie Ihren Speicher mit SANtricity System Manager"].
