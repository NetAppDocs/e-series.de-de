...
---
= Installieren Sie Einschübe im 3040 40U-Schrank - E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können die folgenden Controller-Laufwerksschächte und Erweiterungslaufwerksschächte im E-Series 3040 40U-Schrank installieren.

Falls Ihre Controller-Laufwerksschächte oder Erweiterungslaufwerksschächte unten nicht aufgeführt sind, siehe  https://hwu.netapp.com["NetApp Hardware Universe"^] um zu überprüfen, ob Ihre Controller-Laufwerksschächte oder Erweiterungslaufwerksschächte unterstützt werden.
