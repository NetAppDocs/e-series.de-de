...
---
= Ersetzen Sie den E2800-Aktivkohlebehälter (60 Laufwerke).
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
.. Wählen Sie Menü:Hardware[Controllers and components] unter dem linken Bereich aus.
...
+
image::../media/28_dwg_e2860_de460c_psu_w_callouts_maint-e2800.gif[LEDs des Netzbehälters]
