...
---
= Austausch von Laufwerken in der E2800 (Shelf mit 60 Laufwerken)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/2860_dwg_attn_led_on_drawer_maint-e2800.gif[2860-Dwg-Attn führte auf Schublade maint e2800]
...
+
image::../media/2860_dwg_amber_on_drive_maint-e2800.gif[2860 m Bernstein auf der Antriebsmaint e2800]
...
image::../media/28_dwg_e2860_de460c_attention_led_drive_maint-e2800.gif[28 dwg e2860 de460c Aufmerksamkeit LED Antrieb maint e2800]
