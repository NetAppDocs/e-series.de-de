...
---
= Ersetzen Sie einen Controller in der Duplexkonfiguration – E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
... Wählen Sie *Hardware*.
... Wenn die Grafik die Laufwerke anzeigt, wählen Sie *Rückseite des Gehäuses anzeigen*, um die Controller anzuzeigen
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Entfernen Sie die Frontplatte]
...
+
image::../media/28_dwg_e2800_insert_battery_maint-e2800.gif[Setzen Sie die Batterie wieder ein]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[Installieren Sie die HIC wieder auf dem Controller]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Bringen Sie die Frontplatte wieder an]
...
+
image::../media/28_dwg_e2824_remove_controller_canister_maint-e2800.gif[Setzen Sie den Controller-Behälter wieder ein]
...
+
image::../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif[Setzen Sie den Controller-Behälter wieder ein]
