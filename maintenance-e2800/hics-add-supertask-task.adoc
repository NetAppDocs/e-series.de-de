...
---
= Host-Schnittstellenkarte hinzufügen - E2800 (HIC)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2824_remove_controller_canister_maint-e2800.gif[Entfernen Sie den Controller-Behälter vom Regal]
...
+
image::../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif['Controller-Behälter vom Regal entfernen']
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[Installieren Sie HIC auf der Controllerkarte]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Bringen Sie die Abdeckplatte an der Steuerung an]
...
+
Die folgende Abbildung zeigt ein Beispiel für ein E2860 Controller-Shelf: image:../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif["Setzen Sie den Controller-Aktivkohlebehälter wieder ein"]
