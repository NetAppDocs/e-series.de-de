...
---
= Ersetzen Sie das Netzteil - E2800 (12 Laufwerke oder 24 Laufwerke).
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_913w_power_supply_back_view_maint-e2800.gif[Netzteil-LEDs]
...
+
image::../media/drw_2600_psu_maint-e2800.gif[Ziehen Sie am Nockengriff, um das Netzteil aus der Mittelplatine zu lösen]
