...
---
= E2800 Lüfterbehälter ersetzen (60 Laufwerke)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_led_callout_maint-e2800.gif[28 dwg e2860 de460c Einzelventilator Behälter mit LED Callout e2800]
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_orange_tab_callout_maint-e2800.gif[28 dwg e2860 de460c Einzelventilator Behälter mit orangefarbener Lasche Legende maint e2800]
